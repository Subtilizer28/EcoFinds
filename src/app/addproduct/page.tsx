...
export default function AddProductPage() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center p-6 bg-[#131824] font-sans">
      <div className="max-w-2xl w-full mx-auto backdrop-blur-xl bg-[#23293a]/80 rounded-3xl shadow-2xl border border-[#39415c] p-10">
        {/* Header */}
        ...
        >
          ...
          <button
            type="submit"
            className="w-full mt-6 bg-[#3166fc] text-white py-4 rounded-xl text-lg font-semibold hover:bg-[#254fbf] transition-colors shadow-lg"
          >
            Add Item
          </button>
        </form>
        ...
        <style jsx>{`
          ...
          .input-style:focus {
            border-color: #3166fc; /* Blue as per theme */
            box-shadow: 0 2px 8px rgba(49, 102, 252, 0.4);
          }
        `}</style>
      </div>
    </section>
